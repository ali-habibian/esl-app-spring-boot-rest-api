...
public class CustomExceptionHandler implements ErrorController {
    ...
    //    was used for label #2 lines in application.yml for override white label error
